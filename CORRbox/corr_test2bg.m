function pvalue = corr_test2bg(corrobj1, corrobj2, varargin)
...
%
%   * USAGE
%       pvalue = corr_test2bg(corrobj1, corrobj2)
%       pvalue = corr_test2bg(corrobj1, corrobj2, Name, Value)
%
%   * INPUT
...
if (size(input1.data, 1)~=size(input2.data, 1))
    error("* corr_test2bg : 'corrobj1' and 'corrobj2' should have same dimensions.");
end
